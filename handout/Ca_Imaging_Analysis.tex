...
\item Start MATLAB (menu Applications/Education/Matlab)\todo{check menu}.
...
\begin{itemize}
\item Open the provided file \texttt{calc\_dF\_F.m}. This gets as input the raw trace from one cell and returns as output the $dF/F$. You will \textbf{edit} the function to calculate and return the $dF/F$. In the file:
  \begin{enumerate}
